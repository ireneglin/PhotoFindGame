...
var configAuth = require('./socialKeys');
            ...
            process.nextTick(function() {
                ...
                User.findOne({ 'local.email' :  email }, function(err, user) {
                    ...
                    if (user) {
                        ...
                        newUser.local.isAdmin = (req.body.isAdmin == "true");
                        newUser.local.active = true;
                        newUser.local.totalPoints = 200;
            ...
            process.nextTick(function() {
                ...
                User.findOne({ 'facebook.id' : profile.id }, function(err, user) {
                    ...
                    if (user) {
                        ...
                        newUser.local.city = "Toronto";
                        newUser.local.country = "Canada";
