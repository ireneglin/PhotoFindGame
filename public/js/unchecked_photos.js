...
$.ajax({
        url: "/api/checkpoint/" + getQueryVariable('checkpointid') + "/unhandledsubmissions",
        type: "get",
        dataType: "json",
        success: function(submissions){
          ...
          for(i=0;i<submissions.length;i++){
            ...
            $("#photos_line_" + (1+Math.floor(i/3)).toString()).append('<div class="jumbotron photo" id="photo' + (i+1).toString() + '"><img id="img' + (i+1).toString() + '" src="'+ submissions[i].submissionPhoto +'" alt="Impossible to display the image"></div>');
